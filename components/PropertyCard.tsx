...
function getIndicatorFields(
  ...
  const universalFields: FieldDef[] = [
    ...
    { key: "esgCertification", abbr: "ESG", label: "ESG认证", format: "text", isLocked: true },
    { key: "landFloorPrice", abbr: "LFP", label: "土地楼面价", format: "currency", isLocked: true },
    { key: "capexIntensity", abbr: "CAPEX", label: "单位CapEx", format: "currency", isLocked: true },
    { key: "npiMargin", abbr: "NPI", label: "NPI利润率", format: "percent", isLocked: true },
    ...
    { key: "noiCagr3Y", abbr: "NOI 3Y", label: "NOI增速", format: "percent", isLocked: true },
    ...
    { key: "kolBuzzIndex", abbr: "KOL", label: "KOL热度", format: "number", isLocked: true },
  ...
  const leverageFields: FieldDef[] = [
    ...
    { key: "projectedIrr5Y", abbr: "IRR 5Y", label: "5年预测IRR", format: "percent", isLocked: true },
  ];
