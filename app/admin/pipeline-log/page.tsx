...
export default function PipelineLogPage() {
  ...
  return (
    <div className="vl-content-inner">
      ...
      {loading ? <div className="bw-loading"><div className="bw-spin" /><span>加载中</span></div> : entries.length === 0 ? <div className="vl-empty"><p className="vl-empty-title">暂无运行记录</p><p className="vl-empty-desc">触发全量抓取后显示</p></div> : (
